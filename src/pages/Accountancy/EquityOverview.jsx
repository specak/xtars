    ...
    options: [
      {
        ...
        explanation: 'You invested 20 Lakhs of your money and took 30 Lakhs loan. So Your Ownership = 20 Lakhs, Loan(Liability) = 30 Lakhs.',
      },
    ],
    tableData: {
      equity: '20 Lakhs',
    ...
    options: [
      {
        ...
        explanation: 'You invested 25 Lakhs and friend invested 25 Lakhs. Your Ownership = 25 Lakhs, Friend Ownership = 25 Lakhs',
      },
    ],
    tableData: {
      equity: '25 Lakhs',
    ...
    <div className="min-h-screen bg-[#0f1121] text-white flex flex-col items-center p-4">
      <div className="w-full max-w-3xl flex flex-col md:flex-row md:items-start gap-4 mb-6">
        ...
        <div className="bg-white text-black rounded-xl shadow-md p-6 flex flex-col gap-4 max-w-2xl mx-auto">
          ...
          <p className="text-lg">
            If you need to buy a house worth 50 Lakhs and you have {selected.you} in the
            cash/account. What will you do?
          </p>
